...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0) {
			throw new TreeException("Invalid tree");
		}
		...
		else
		{
			...
			if(parentNode == null) {
				throw new TreeException("Incorrect data file");
			}
		}
		...
		for(String str : childrenArray) {
			TreeNode childNode = new TreeNode(str);
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null) {
			throw new TreeException("Invalid node name");
		}
